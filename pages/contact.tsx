    ...
    return(
       ...
       <meta name="lp-version" content="v6.23.11"/>
        ...
        <div className={styles["header_container"] + " " + styles["head_nav_container"]}>
            ...
            <span className={styles.e_contact_logo_outside}>
                    <svg width="225.458" height="65.111" viewBox="0 0 225.458 118.111">
                        <g id="Group_46" data-name="Group 46" transform="translate(-126.281 -242.833)">
                        <path id="Path_15315" data-name="Path 15315" d="M235.531,249.652l-3.99,3.091-23.335,18.052,3.1,4,23.325-18.056,5.123,6.621,3.1,3.993,4-3.091,11.589-8.977,3.235,4.172,4.371-8.32,4.36-8.306-9.136,2.144-9.146,2.139,3.22,4.167-11.589,8.983-5.124-6.617-3.1-4" transform="translate(-7.61)" fill="white" fill-rule="evenodd"/>
                        <rect id="Rectangle_78" data-name="Rectangle 78" width="9.924" height="7.929" transform="translate(200.844 283.466)" fill="white"/>
                        <rect id="Rectangle_79" data-name="Rectangle 79" width="9.919" height="40.488" transform="translate(263.696 250.907)" fill="white"/>
            ...
            <ul ref={menuRef} className={active ? styles.activeE_more_contents : styles.e_more_contents}>

                    <span className={styles.closeMenuStyle}>

                        <svg xmlns="http://www.w3.org/2000/svg" width="225.458" height="78.111" viewBox="0 0 225.458 118.111">
                            <g id="Group_46" data-name="Group 46" transform="translate(-126.281 -242.833)">
                            <path id="Path_15315" data-name="Path 15315" d="M235.531,249.652l-3.99,3.091-23.335,18.052,3.1,4,23.325-18.056,5.123,6.621,3.1,3.993,4-3.091,11.589-8.977,3.235,4.172,4.371-8.32,4.36-8.306-9.136,2.144-9.146,2.139,3.22,4.167-11.589,8.983-5.124-6.617-3.1-4" transform="translate(-7.61)" fill="#00c39e" fill-rule="evenodd"/>
                   ...
                   <div className={styles.shortcutMD1}>

                    <span className={styles.e_shortcutmenu_options}>
                        <span className={styles.e_shortcut_Menu_details}   onClick={()=> router.push('/')}>
                            <span className={styles.e_menu_shortcut_icons}>
                            <i className="fa fa-wpforms e_nav_contents_two_icons e_nav_contents_two_icon_one"></i>
                            </span>

                            <span className={styles.e_menu_shortcut_title}>
                            <p className={styles.e_more_contents_links}> DASHBOARD</p>
                            </span>
                        </span>

                        <span className={styles.e_shortcut_Menu_details} onClick={()=> router.push('/contact')}>
                            <span className={styles.e_menu_shortcut_icons}>
                            <i className="fa fa-id-card-o e_nav_contents_two_icons e_nav_contents_two_icon_one"></i>
                            </span>
                            
                            <span className={styles.e_menu_shortcut_title}>
                                <p className={styles.e_more_contents_links}> CONTACT</p>
                            </span>
                        </span>

                        <span className={styles.e_shortcut_Menu_details}>
                            <span className={styles.e_menu_shortcut_icons}>
                                <i className="fa fa-user e_nav_contents_two_icons e_nav_contents_two_icon_one"></i> 
                            </span>
                            <span className={styles.e_menu_shortcut_title}>
                                <p className={styles.e_more_contents_links}>LOGIN</p>
                            </span>
                        </span>
                        ...
                        <span className={styles.e_shortcut_Menu_details}>
                            ...
                            <span className={styles.e_menu_shortcut_icons}>
                                <i className="fa fa-pencil e_nav_contents_two_icons e_nav_contents_two_icon_two"></i>
                            </span> 
                            
                            <span className={styles.e_menu_shortcut_title}>
                                <p className={styles.e_more_contents_links}>REGISTRATION</p>
                            </span>
                        </span>
                    </span>
        ...
        <ul className={styles.e_main_content_container_list}>
                ...
                <li className={styles.e_main_content_list}>Email
                    <ul className={styles.e_main_content_list_email_address}>
        ...
        <div className={styles.e_footer_content_container}>
            ...
            <ul className={styles.e_footer_content_container_list}>
                <li className={styles.e_footer_content_list} id={styles.e_footer_content_contacts} onClick={()=> router.push('/contact')}>CONTACTS</li>
